...
/**
 * Controller class for the Administrator Window interface.
 * This class handles the administration functionality including user management,
 * profile updates, and system operations. It provides an interface for administrators
 * to view, modify, and delete user accounts with comprehensive validation and
 * data management capabilities.
 * 
 * The controller implements JavaFX Initializable interface to properly
 * initialize the UI components and set up event handlers for user interactions.
 */
public class AdminWindowController implements Initializable
{
    ...
    /**
     * Sets the main controller and initializes the administrator interface.
     * This method configures the controller reference, retrieves the currently
     * logged-in admin profile from the LoggedProfile singleton, displays the
     * admin username, and loads the list of users from the system.
     *
    ...
    /**
     * Retrieves the complete list of users from the system and populates
     * the users combo box. This method fetches all user records through
     * the main controller and updates the UI component to display them.
     * If an error occurs during retrieval, an error alert is displayed
    ...
    /**
     * Clears all user input fields and resets the selection state.
     * This method resets all text fields, radio buttons, and clears
     * the currently selected user reference to prepare the interface
     * for new user selection or operations.
     */
    ...
    /**
     * Refreshes the user list and clears all input fields.
     * This method reloads the user data from the system and resets
     * the form to its initial state, ensuring the interface displays
     * the most current user information.
     */
    ...
    /**
     * Loads the data of the currently selected user into the form fields.
     * This method populates all input fields with the information of the
     * selected user, including personal details, contact information,
     * and payment card data. If no user is selected, the method returns
    ...
    /**
     * Saves the changes made to the selected user's profile.
     ...
     * If validation fails or the update operation encounters an error,
     * appropriate alert messages are displayed to the administrator.
     * 
    ...
    /**
     * Initiates the user deletion process by opening a verification window.
     * This method opens a confirmation dialog that requires additional
     * verification before permanently deleting a user account. If no user
     * is selected, an error alert is displayed. Upon successful deletion,
     * the user list is refreshed through a callback mechanism.
     */
    @FXML
    ...
    /**
     * Logs out the current administrator and returns to the login screen.
    ...
    /**
     * Validates all input fields in the user form.
     * This method checks each required field for proper formatting
     * and content according to business rules, applying visual
     * error styling to invalid fields.
     *
     * @return true if all fields pass validation, false if any
    ...
    /**
     * Initializes the controller class and sets up event handlers.
     * This method is automatically called after the FXML file has been loaded
     * and initializes the user interface components, including setting up
     * the user selection combo box handler and configuring input validation
     * for telephone and card number fields.
     *
