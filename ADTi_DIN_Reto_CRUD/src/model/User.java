...
/**
 * Represents a regular user in the system, extending the base Profile class.
 * This class contains user-specific attributes including gender information
 * and payment card details, providing the complete data model for standard
 * user accounts in the application.
 * 
 * User objects are used throughout the system for authentication, profile
 * management, and personalization features.
 */
public class User extends Profile
{
    ...
    /**
     * Constructs a new User instance with full profile information including ID.
     * This constructor is typically used when loading existing user data
    ...
    /**
     * Constructs a new User instance with basic profile information excluding ID.
     * This constructor is typically used when creating new user accounts
     ...
     * This method overrides the parent class toString() to provide only
     * the username, which is useful for display purposes in UI components
    ...
    /**
     * Returns a detailed string representation of the user profile.
     * This method provides a formatted string containing all profile information
     * along with a masked version of the payment card for security purposes.
     *
     * @return a formatted string representation of the user profile
     *         with sensitive card information partially masked
     */
    @Override
    public String show()
    {
