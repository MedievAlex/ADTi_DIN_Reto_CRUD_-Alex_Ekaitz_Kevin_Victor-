...
/**
 * Unit tests for the Controller class using MockModelDAO for isolation.
 * These tests verify that the Controller properly delegates operations to the DAO
 * and correctly handles both successful responses and exceptions.
 */
public class ControllerTest {
     ...
     * Initializes a new MockModelDAO and Controller instance for each test.
    ...
    /**
     * Tests user registration through the Controller.
     * Verifies that the registered user matches the expected mock user data.
     * @throws exception.OurException
     */
    @Test
    ...
    /**
     * Tests user login functionality through the Controller.
     * Verifies that login returns the expected user profile with correct data.
     * @throws exception.OurException
     */
    @Test
    ...
    /**
     * Tests retrieval of all users through the Controller.
     * Verifies that the user list is not empty and contains the expected mock user.
     * @throws exception.OurException
     */
    @Test
    ...
    /**
     * Tests user update operation through the Controller.
     * Verifies that the update operation returns true for successful updates.
     * @throws exception.OurException
     */
    @Test
    ...
    /**
     * Tests user deletion through the Controller.
     * Verifies that deletion returns true for valid IDs and false for invalid IDs.
     * @throws exception.OurException
     */
    @Test
    ...
    /**
     * Tests exception propagation from DAO to Controller.
     * Verifies that exceptions thrown by the DAO are properly propagated.
     * @throws exception.OurException
     */
